...
public class CreditPaymentTest extends BaseTest{
    ...
    void ShouldSuccessMessageWhenPaymentByCreditApprovedCard(){
    ...
    @Story("Всплывающее окно со статусом операции")
    void ShouldErrorMessageWhenPaymentByCreditDeclinedCard(){
        var mainPage = open("http://localhost:8080", MainPage.class);
        var creditPaymentPage = mainPage.paymentByCredit();
    ...
    @Story("Всплывающее окно со статусом операции")
    void ShouldErrorMessageWhenPaymentFailedCard(){
        var mainPage = open("http://localhost:8080", MainPage.class);
        var creditPaymentPage = mainPage.paymentByCredit();
        creditPaymentPage.pay(DataHelper.getFailedCardInfo());
